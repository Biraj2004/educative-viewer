...
export default function TopicLayoutClient({
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
      ...
      {drawingsEnabled && drawingPadOpen && (
        <div
          className={`fixed top-14 bottom-0 right-0 z-50 border-l border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 shadow-2xl will-change-[opacity] transition-opacity duration-300 ease-out ${drawingPanelVisible ? "pointer-events-auto" : "pointer-events-none"}`}
          style={{
