                                                ...
                                                return (
                                                    <li key={topic.topic_index}>
                                                        <Link
                                                            ...
                                                            className={[
                                                                "block relative px-4 py-2.5 pr-10 text-sm transition-colors border-b border-gray-50 dark:border-gray-800",
                                                                isActive
                                                        ...
                                                        >
                                                            ...
                                                            <span className="leading-snug inline">{topic.title}</span>
                                                            {(isDone || isBookmarked) && (
                                                                <div className="absolute right-3 top-3 flex items-center gap-1.5">
                                                                    ...
                                                                    {isBookmarked && (
                                                                        <svg className="w-3.5 h-3.5 text-amber-500" fill="currentColor" viewBox="0 0 20 20" aria-label="Bookmarked topic">
                                    ...
                                    <ul key={i}>
                                        <li>
                                            ...
                                            >
                                                ...
                                                <span className="leading-snug inline">{entry.title}</span>
                                                {(isDone || isBookmarked) && (
                                                    <div className="absolute right-3 top-3 flex items-center gap-1.5">
                                                        {isDone && (
                                                            <svg className="w-3.5 h-3.5 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
