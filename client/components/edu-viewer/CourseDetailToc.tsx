                          ...
                          >
                            {isDone ? (
                             <div className="flex items-center gap-1 shrink-0 w-10 justify-end text-right select-none">
                               ...
                               <span className="text-[11px] font-mono shrink-0 text-emerald-600 dark:text-emerald-400">
                                 {topic.topic_index + 1}
                               </span>
                             </div>
                           ) : (
                             <span className="text-[11px] font-mono text-gray-300 dark:text-gray-600 w-10 text-right shrink-0">
                               {topic.topic_index + 1}
                             </span>
                           )}
