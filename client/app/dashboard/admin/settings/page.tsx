      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12 max-w-7xl">
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 space-y-6">
          ...
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Course SQLite DB Folder (Dynamic Loader)</label>
              <input type="text" name="course_sqlite_db_folder" value={settings.course_sqlite_db_folder || ''} onChange={handleChange} className="mt-1 block w-full rounded-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm dark:text-white" placeholder="C:\path\to\legacy\dbs" />
            </div>
          </div>
